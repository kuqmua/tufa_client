    ...
    Some(count) => {
      ...
      let inner_html = match count_to_show.len() {
        ...
        2 => {
          ...
          match first_element {
            '0' => {first_zero_class = current.clone();},
            '1' => {first_one_class = current.clone();},
            '2' => {first_two_class = current.clone();},
            '3' => {first_three_class = current.clone();},
            '4' => {first_four_class = current.clone();},
            '5' => {first_five_class = current.clone();},
            '6' => {first_six_class = current.clone();},
          ...
          match second_element {
            '0' => {second_zero_class = current;},
            '1' => {second_one_class = current;},
            '2' => {second_two_class = current;},
            '3' => {second_three_class = current;},
            '4' => {second_four_class = current;},
            '5' => {second_five_class = current;},
            '6' => {second_six_class = current;},
