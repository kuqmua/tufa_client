...
pub struct RefOptionListProps {
    ...
    pub scroll_to: Option<Callback<()>>, //(args: number | ScrollConfig) => void
}
...
pub fn is_title_type(content: TitleType) -> bool {
    match content {
        TitleType::String(_) => true,
        TitleType::Number(_) => true,
        //todo
    }
}
...
pub fn option_list(props: &RefOptionListProps) -> Html {
    //todo props
